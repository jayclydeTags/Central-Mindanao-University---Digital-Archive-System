            ...
            <v-data-table :headers="headers" v-model="selected" :items="fetchFiles" :search="search" item-key="file_id"
                                            ...
                                            <v-form ref="form" @submit.prevent="save">
                                                ...
                                                ">
                                                    ...
                                                    <v-textarea v-show="
                                                        formTitle === 'New File' ||
                                                        formTitle === 'Update File'
                                                    " v-model="form.description" :rules="rules.description" prepend-inner-icon="mdi-text" filled
                                                        name="input-7-4">
                                                    </v-textarea>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input"
                                                            ...
                                                            v-show="formTitle === 'File Location'" v-if="uploadReady"
                                                            :rules="rules.file_location" ref="file"
                ...
                <template v-slot:item.actions="{ item }">
                    <v-btn-toggle v-model="icon" borderless>
                        ...
                        <v-btn value="center" x-small color="warning" @click="editFileLocation(item)">
