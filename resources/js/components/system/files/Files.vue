<template>
    <v-container>
        <v-row>
            ...
            <v-col cols="12">
                <v-card flat color="grey lighten-3 action-tab--shadow rounded-lg pa-2">
                    <v-tabs hide-slider v-model="tabs" active-class="green lighten-2 grey--text text--darken-4 rounded"
                        ...
                        <v-tab href="#mobile-tabs-5-3" class="grey--text text--darken-1"
                            v-show="auth.user_type === 'Staff'">
                            <!-- <v-icon>mdi-file-compare </v-icon>  -->
                            File Disposal
                        </v-tab>
                        <v-tab href="#mobile-tabs-5-4" class="grey--text text--darken-1"
                    ...
                    <v-tabs-items v-model="tabs">
                        <v-tab-item v-for="i in 4" :key="i" :value="'mobile-tabs-5-' + i">
                            ...
                            <v-card flat v-if="i === 3">
                                <file-disposal-table></file-disposal-table>
                            </v-card>
                            <v-card flat v-if="i === 4">
                                <file-category-table></file-category-table>
                            </v-card>
                        </v-tab-item>
                    </v-tabs-items>
                </v-card>
