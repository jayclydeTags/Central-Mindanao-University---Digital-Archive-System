    ...
    <div class="container">
        <v-card>
            <v-card-title>
                ...
                <v-spacer></v-spacer>
                <v-text-field v-model="search" dense filled label="Search" prepend-inner-icon="mdi-magnify">
                </v-text-field>
            </v-card-title>
            ...
            <v-data-table :headers="headers" :items="fetchFileLocations" :search="search" v-model="selected"
                                ...
                                <v-card-text>
                                    <v-container>
                                        <v-form ref="form" @submit.prevent="save">
                                            <v-text-field v-show="formTitle === 'Update File'" v-model="form.file_id"
                                                prepend-inner-icon="mdi-information-outline" label="File ID" disabled
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        v-show="formTitle === 'Update File'" v-if="uploadReady"
                                                        :rules="rules.file_location" ref="fileupload"
                                                        @change="onChangeFile" required />

                                                    <label class="custom-file-label" for="inputGroupFile01">{{ filename
                                                    }}</label>
                                                </div>
                                            </div>
                                            <div v-if="isLoading">
                ...
                <template v-slot:item.actions="{ item }">
                    ...
                    <v-btn-toggle v-model="icon" borderless>
                        ...
                        <v-btn value="center" x-small color="success" @click="showFile(item)">
