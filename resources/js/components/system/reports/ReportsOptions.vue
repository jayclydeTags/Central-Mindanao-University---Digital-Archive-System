    ...
    <div>
        ...
        <v-row class="mt-2">
            <v-col cols="12" md="6" sm="8">
                <v-select :items="selection" v-model="selectionDefault" @change="onChangeSelection" filled dense>
                </v-select>
            </v-col>
            <v-col cols="12" md="6" sm="8">
                <div v-if="documentid === 'requestreports'">
                    <v-select :items="items" v-model="period" @change="onChangePeriod" filled dense>
                    </v-select>
                </div>

                <div v-else>
                    <v-select :items="uploadperioditems" v-model="uploadperiod" @change="onChangePeriodUploads" filled
                        dense>
                    </v-select>
                </div>
            </v-col>
        ...
        <v-row>
            <v-col cols="12" sm="16" id="buttons">
                <v-btn-toggle v-model="icon" borderless>
                    ...
                    <v-btn value="center" color="success" small @click="downloadChartImage">
