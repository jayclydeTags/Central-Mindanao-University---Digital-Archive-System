<template>
    <v-container class="grey lighten-3 action-tab--shadow">
        <v-row>
            <!-- Alert Message -->
            ...
            <v-col cols="12" sm="8">
                        ...
                        <v-row>
                            <v-col cols="12" class="mb-n7">
                                <v-text-field v-model="form.name" label="Name" outlined dense
                                    prepend-inner-icon="mdi-account" :rules="rules.editProfileRules.name" required>
                                </v-text-field>
                            </v-col>
                            <v-col cols="12" class="mb-n7">
                                <v-text-field v-model="form.email" label="Email" disabled outlined
                                    prepend-inner-icon="mdi-email" dense :rules="rules.editProfileRules.email" required>
                                </v-text-field>
                            </v-col>

                            <v-col cols="12" class="mb-n7">
                                <v-text-field v-model="form.address" label="Address" outlined dense
                                    prepend-inner-icon="mdi-map-marker" :rules="rules.editProfileRules.address"
                                    required></v-text-field>
                            </v-col>
                            <v-col cols="12" class="mb-n7">
                                <v-text-field v-model="form.phone_no" label="Contact No." outlined dense
                                    prepend-inner-icon="mdi-phone" :rules="rules.editProfileRules.phone_no" required
                                    type="number"></v-text-field>
                            </v-col>
                            <!-- commented -->
                            <!-- <v-col cols="12" class="mb-n7">
                                <v-text-field label="Current Password" v-model="form.password" outlined dense
                ...
                <v-dialog v-model="passworddialog" width="500">
                    ...
                    <v-card>
                        ...
                        <v-container>
                            <v-col cols="12" class="mb-n6 pa-0">
                                <v-text-field label="Enter your password" v-model="form.password" outlined dense
                                    :append-icon="showpass ? 'mdi-eye' : 'mdi-eye-off'"
                                    :type="showpass ? 'text' : 'password'" @click:append="showpass = !showpass"
                                    :rules="rules.editProfileRules.password" required>
                                </v-text-field>
                        ...
                        <v-container>
                            <v-form ref="form" @submit.prevent="save" v-model="rules.isValid" lazy-validation
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" class="mb-n6">
                                        <v-text-field label="New Password" v-model="form.newpass" outlined dense
                                            :append-icon="showpass ? 'mdi-eye' : 'mdi-eye-off'"
                                            :type="showpass ? 'text' : 'password'" @click:append="showpass = !showpass"
                                            :rules="rules.updatePasswordRules.password" required>
                                        </v-text-field>
