    ...
    <div class="container d-flex justify-center">
        ...
        <div v-else class="d-flex justify-center">
            <!-- <v-container>
                ...
                <img :src="getFile.filecontent" class="my-5" width="60%" />
            <canvas id="the-canvas"></canvas>
        </div>
    </div>
</template>
            ...
            if (this.getFileType === "pdf") {
                ...
                function renderPage(num) {
                    ...
                    pdfDoc.getPage(num).then(function (page) {
                        ...
                        canvas.style.height = `${(viewport.height * displayWidth) / scale
                            }px`;
                        textLayer.style.width = `${(viewport.width * displayWidth) / scale
                            }px`;
                        textLayer.style.height = `${(viewport.height * displayWidth) / scale
                            }px`;
