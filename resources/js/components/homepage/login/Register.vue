                ...
                <v-card max-width="800">
                    ...
                    <v-card-text>
                        ...
                        <v-container>
                            <v-form ref="form" @submit.prevent="save" v-model="rules.isValid" lazy-validation>
                                <v-row>
                                    <v-col cols="12">
                                        <v-text-field v-model="form.name" label="Name" filled dense
                                ...
                                <v-row class="mt-n6">
                                    <v-col cols="12">
                                        <v-text-field v-model="form.address" label="Address" filled dense
                                ...
                                <v-row class="mt-n6">
                                    <v-col cols="12">
                                        <v-text-field v-model="form.phone_no" label="Contact No." filled dense
                                            prepend-inner-icon="mdi-phone" :rules="rules.phone_no" type="number"
                                ...
                                <v-row class="mt-n6">
                                    <v-col cols="12">
                                        <v-text-field label="Password" v-model="form.password_confirmation" filled
                    ...
                    <v-card-actions>
                        <v-row>
                            ...
                            <v-col cols="12" md="6" sm="8">
                                <v-btn x-large text
                                    @click="$router.push({ name: 'authentication', params: { action: 'login' } })">Already
